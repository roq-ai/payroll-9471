...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'earnings', header: 'earnings', accessorKey: 'earnings' },
    { id: 'deductions', header: 'deductions', accessorKey: 'deductions' },
    { id: 'federal_tax', header: 'federal_tax', accessorKey: 'federal_tax' },
    { id: 'local_tax', header: 'local_tax', accessorKey: 'local_tax' },
