      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'earnings',
              isInvalid: !!formik.errors?.earnings,
            }}
            name="earnings"
            error={formik.errors?.earnings}
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'federal_tax',
              isInvalid: !!formik.errors?.federal_tax,
            }}
            name="federal_tax"
            error={formik.errors?.federal_tax}
            value={formik.values?.federal_tax}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('federal_tax', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'local_tax',
              isInvalid: !!formik.errors?.local_tax,
            }}
            name="local_tax"
            error={formik.errors?.local_tax}
            value={formik.values?.local_tax}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('local_tax', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
